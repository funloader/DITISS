...
1. Write your solution using Go Programming Language or Python Programming Language. Do not submit your solution with both languages at once!
2. You may only use standard library packages. In addition, an extra point is awarded if the solution does not declare any global variables.

**Specific rules for Go solution**
1. Your source code must be a single file.
2. Do not use any for and goto statements.
3. Your solution will be tested against Go 1.25 (as of August 2025) or higher.
...
1. Your source code must be a single file, including at least a main function.
2. Do not use any for or while loop statements, or any list / set / dictionary comprehension syntax.
3. Your solution will be tested against Python 3.13 (as of January 2025) or higher.
