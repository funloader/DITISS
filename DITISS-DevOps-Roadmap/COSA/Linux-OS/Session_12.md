...
## 🛠️ **7. Corrections / Improvements / Suggested Substitutions**

* COSA briefly lists DNS → explicitly add **record types table**
* Emphasize **forward vs reverse lookup**
* Clarify **BIND vs named vs DNS**
* Add **UDP vs TCP usage** (often asked)

---

## 🧪 **8. Lab Alignment (Practical + Viva)**
...
* Verify name resolution using nslookup/dig

---

✅ **These notes are optimized for PG-DITISS MCQs, DNS labs, and viva preparation.**

If you want next:

* 🔹 **DNS MCQs**
* 🔹 **DNS configuration step-by-step lab sheet**
* 🔹 **Forward vs Reverse DNS diagram**
